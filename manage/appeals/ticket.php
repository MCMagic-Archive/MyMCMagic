<?php
    ...
    if(!isset($_GET['id']) || $_GET['id']==''){
        header("Location: ../appeals/");
        exit();
    }
    $id = $_GET['id'];
    mysqli_select_db($conn, "mymcmagic");
    $q = mysqli_query($conn, "SELECT answer_tickets FROM users WHERE id='" . $_SESSION['ID'] . "';");
    if(mysqli_fetch_assoc($q)['answer_tickets'] == 0){
        header("Location: ../appeals/?tag=not-trained");
        exit();
    }
    $subject = '';
    $status = 0;
    $time = 0;
    $messages = array();
    $tq = mysqli_query($conn, "SELECT subject,status,time FROM ticketids WHERE ticketid='" . $id . "';");
                                        ...
                                        <div class="portlet light profile-sidebar-portlet ">
                                            ...
                                            <div class="profile-usermenu">
                                                <ul class="nav">
                                                    <li>
                                                        <a href="../appeals/">
                                                            <i class="fa fa-ticket" aria-hidden="true"></i> Support Tickets </a>
                                                    </li>
                                                    <li>
                                                        <a href="../player/">
                                                            <i class="fa fa-users" aria-hidden="true"></i> Player Lookup </a>
                                                    </li>
                                                    <li>
                                                        <a href="../chatlog/">
                                                            <i class="fa fa-comments-o" aria-hidden="true"></i> Chat Lookup </a>
                                                    </li>
                                                    <li>
                                                        <a href="../transactions/">
                                                            <i class="fa fa-usd" aria-hidden="true"></i> Guest Transactions </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
            ...
            ?>
                ...
                <script>
                    ...
                    document.getElementById('toggle-btn').onclick = function () {
                        document.getElementById('toggle').value = "<?php echo ($status != 0 ? "0" : "1"); ?>";
