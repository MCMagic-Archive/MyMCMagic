...
[if !IE]><!-->
    ...
    <body class="page-container-bg-solid page-md">
                                                ...
                                                <div class="portlet light">
                                                    <div class="portlet-title">
                                                        <div class="caption caption-md">
                                                            ...
                                                            <span class="caption-subject font-blue-madison bold uppercase">Transaction History Lookup</span>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row number-stats margin-bottom-30">
                                                            <form class="account-settings-form" id="form">
                                                                <div class="form-group">
                                                                    <p>Search for a Guest's transaction history:</p>
        ...
        ?>
            ...
            <script src="/assets/pages/scripts/transactions_page.js" type="text/javascript"></script>
            <!-- END PAGINATION CODE -->
